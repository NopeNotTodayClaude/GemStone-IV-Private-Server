...
Appearance.suggested_stats = {
    [1]  = { 90, 85, 70, 70, 75, 45, 45, 60, 45, 75 },   -- Warrior
    [2]  = { 65, 55, 95, 90, 70, 50, 55, 85, 45, 50 },   -- Rogue
    [3]  = { 45, 55, 55, 65, 75, 95, 90, 60, 60, 60 },   -- Wizard
    [4]  = { 55, 65, 55, 60, 65, 60, 60, 80, 95, 65 },   -- Cleric
    [5]  = { 45, 65, 55, 60, 70, 60, 55, 65, 90, 95 },   -- Empath
    [6]  = { 45, 55, 55, 60, 70, 95, 90, 60, 85, 45 },   -- Sorcerer
    [7]  = { 70, 60, 90, 70, 70, 55, 50, 90, 60, 45 },   -- Ranger
    [8]  = { 60, 60, 65, 65, 60, 75, 55, 65, 55, 100 },  -- Bard
    [9]  = { 90, 85, 60, 65, 70, 55, 45, 55, 90, 45 },   -- Paladin
    [10] = { 85, 70, 65, 90, 85, 55, 60, 65, 45, 40 },   -- Monk
}
