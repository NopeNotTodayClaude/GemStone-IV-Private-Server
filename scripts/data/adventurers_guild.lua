...
AG.bounties = {
    ["Wehnimer's Landing"] = {
        ...
        { key = "wl_bandit_hobgoblin", type = "bandit", min_level = 6, max_level = 15, target_template_id = "rogue_hobgoblin_marauder", encounter_template_id = "rogue_hobgoblin_marauder", target_name = "rogue hobgoblin marauder", target_count = 4, reward_silver = 780, reward_experience = 345, reward_fame = 24, reward_points = 3, area = "the rough country around the Landing" },
        { key = "wl_boss_orc",       type = "boss", min_level = 10, max_level = 20, target_template_id = "lesser_orc_warleader", encounter_template_id = "lesser_orc_warleader", target_name = "lesser orc warleader", target_count = 1, reward_silver = 1180, reward_experience = 520, reward_fame = 34, reward_points = 4, area = "the rough country beyond the Landing" },
        { key = "wl_escort_moot_hall", type = "escort", min_level = 1, max_level = 12, target_name = "a nervous guild courier", escort_npc_name = "a nervous guild courier", escort_npc_description = "The courier keeps one hand clamped over a leather satchel full of guild papers and glances around with obvious unease.", escort_enemy_template_id = "hobgoblin", target_count = 2, reward_silver = 360, reward_experience = 165, reward_fame = 11, reward_points = 1, area = "between the Adventurer's Guild and Moot Hall", destination_room_id = 7970, destination_name = "Moot Hall", report_room_id = 3785 },
        { key = "wl_rescue_catacombs", type = "rescue", min_level = 3, max_level = 14, target_name = "a missing tunnel runner", rescue_npc_name = "a missing tunnel runner", rescue_npc_description = "The tunnel runner is dust-caked, frightened, and eager to get back to town under protection.", rescue_enemy_template_id = "cave_gnome", target_count = 2, reward_silver = 560, reward_experience = 250, reward_fame = 17, reward_points = 2, area = "the catacombs beneath the Landing", search_zone_names = { "the catacombs" }, search_room_ids = { 3933, 3934, 3935, 3936, 3937, 404 }, report_room_id = 3785 },
    },
    ["Icemule Trace"] = {
        ...
        { key = "imt_bandit_orc",    type = "bandit", min_level = 8, max_level = 18, target_template_id = "lesser_orc_raider", encounter_template_id = "lesser_orc_raider", target_name = "lesser orc raider", target_count = 4, reward_silver = 830, reward_experience = 370, reward_fame = 25, reward_points = 3, area = "the rough country north of Icemule" },
        { key = "imt_boss_hound",    type = "boss", min_level = 9, max_level = 20, target_template_id = "ice_hound_pack_leader", encounter_template_id = "ice_hound_pack_leader", target_name = "ice hound pack leader", target_count = 1, reward_silver = 1230, reward_experience = 540, reward_fame = 35, reward_points = 4, area = "the harder trails beyond Icemule" },
        { key = "imt_escort_bondsman", type = "escort", min_level = 1, max_level = 12, target_name = "a worried guild courier", escort_npc_name = "a worried guild courier", escort_npc_description = "The courier clutches a dispatch case tight against the cold and sticks close to anyone offering protection.", escort_enemy_template_id = "kobold_imt", target_count = 2, reward_silver = 370, reward_experience = 170, reward_fame = 11, reward_points = 1, area = "between the guild office and the bondsman's counter", destination_room_id = 2438, destination_name = "the bondsman's counter", report_room_id = 3779 },
        { key = "imt_rescue_snowfield", type = "rescue", min_level = 4, max_level = 16, target_name = "a missing snow-runner", rescue_npc_name = "a missing snow-runner", rescue_npc_description = "The snow-runner is shivering badly, but can still make the trip back if someone guards the way.", rescue_enemy_template_id = "leaper", target_count = 2, reward_silver = 590, reward_experience = 265, reward_fame = 18, reward_points = 2, area = "the southern snowfields", search_zone_names = { "the southern snowfields" }, report_room_id = 3779 },
    },
    ["Ta'Vaalor"] = {
        ...
        { key = "tv_bandit_raider",  type = "bandit", min_level = 8, max_level = 18, target_template_id = "raider_orc_marauder", encounter_template_id = "raider_orc_marauder", target_name = "raider orc marauder", target_count = 4, reward_silver = 860, reward_experience = 390, reward_fame = 26, reward_points = 3, area = "the roads and farms outside Ta'Vaalor" },
        { key = "tv_boss_troll",     type = "boss", min_level = 12, max_level = 20, target_template_id = "neartofar_troll_champion", encounter_template_id = "neartofar_troll_champion", target_name = "neartofar troll champion", target_count = 1, reward_silver = 1280, reward_experience = 560, reward_fame = 36, reward_points = 4, area = "Neartofar Forest" },
        { key = "tv_escort_clerk",   type = "escort", min_level = 1, max_level = 12, target_name = "a junior legion courier", escort_npc_name = "a junior legion courier", escort_npc_description = "The young courier holds a bundle of sealed contracts and watches the road with military nervousness.", escort_enemy_template_id = "thyril_meadows", target_count = 2, reward_silver = 390, reward_experience = 180, reward_fame = 12, reward_points = 1, area = "between the taskmaster and the guild clerk", destination_room_id = 10331, destination_name = "the guild clerk's foyer", report_room_id = 10332 },
        { key = "tv_rescue_road",    type = "rescue", min_level = 4, max_level = 16, target_name = "a missing legion runner", rescue_npc_name = "a missing legion runner", rescue_npc_description = "The legion runner is bruised and winded, but ready to move once someone clears a path back to the guild.", rescue_enemy_template_id = "neartofar_orc", target_count = 2, reward_silver = 620, reward_experience = 280, reward_fame = 19, reward_points = 2, area = "the roads beyond the city gates", search_zone_names = { "Timmorain Road", "the Rambling Meadows", "the Neartofar Road" }, search_room_ids = { 5830, 5831, 5833, 5950, 5951, 5952 }, report_room_id = 10332 },
    },
}
