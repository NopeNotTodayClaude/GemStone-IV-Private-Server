-- NPC: a forge clerk
-- Auto-generated shopkeeper binding for room 1954
local NPC = {}
NPC.template_id    = "kdz_forge_supply_clerk"
NPC.name           = "a forge clerk"
NPC.article        = "a"
NPC.title          = "supply clerk"
NPC.description    = "A heat-toughened clerk who keeps smelting supplies moving despite the island's constant dust."
NPC.home_room_id   = 1954
