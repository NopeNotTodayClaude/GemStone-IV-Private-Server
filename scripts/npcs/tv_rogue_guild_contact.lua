...
NPC.dialogues = {
    ...
    invite = "The alley keeps its own secrets.  Earn your invitation first, then use the sequence.",
    password = "The alley sequence begins with a lean.  The rest is not repeated lightly.",
