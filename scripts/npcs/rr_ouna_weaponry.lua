-- NPC: Ouna
-- Auto-generated shopkeeper binding for room 33583
local NPC = {}
NPC.template_id    = "rr_ouna_weaponry"
NPC.name           = "Ouna"
NPC.article        = ""
NPC.title          = "weaponsmith"
NPC.description    = "A compact weapons dealer whose stock favors practicality over flourish."
NPC.home_room_id   = 33583
...
NPC.dialogues = {
    ...
    default = "Ouna nods toward the stock.  'Use LIST to see what's available.'",
}
NPC.ambient_emotes = {
