-- NPC: a supply clerk
-- Auto-generated shopkeeper binding for room 13270
local NPC = {}
NPC.template_id    = "tai_forge_supply_clerk"
NPC.name           = "a supply clerk"
NPC.article        = "a"
NPC.title          = "supply clerk"
NPC.description    = "An elven supply clerk who keeps the forge inventory in faultless order."
