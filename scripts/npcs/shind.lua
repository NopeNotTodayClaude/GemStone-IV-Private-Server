...
NPC.dialogues = {
    ...
    guild = "The rogue guild keeps its own business, but any proper rogue should learn Lock Mastery if they mean to live long.",
    rogue = "If you mean the guild, they value quiet hands and patience more than swagger.",
