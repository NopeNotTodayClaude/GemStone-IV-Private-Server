...
class CommandRouter:
    ...
    def register_default_commands(self):
        ...
        self.register("footstomp", cmd_cheapshot)
        self.register("nosetweak", cmd_cheapshot)
        self.register("templeshot", cmd_cheapshot)
        self.register("kneebash", cmd_cheapshot)
        self.register("eyepoke", cmd_cheapshot)
        self.register("throatchop", cmd_cheapshot)
        self.register("swiftkick", cmd_cheapshot)
